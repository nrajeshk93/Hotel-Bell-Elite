...
REPORT_DEFINITIONS = [
    ...
    },
    {
        "id": "meal_plan",
        "name": "Meal Plan",
        "description": "In-house rooms by meal plan — guest covers for breakfast, lunch, and dinner.",
        "icon": "menu",
        "icon_tone": "teal",
        "category": "restaurant",
    ...
    },
    {
        "id": "agency_billing",
        "name": "Agency Ledger",
        "description": "Hotel agency credit invoices — billed, collections, outstanding, and Excel export.",
        "icon": "ledger",
        "icon_tone": "orange",
        "category": "sales",
        "view_route": "sales_report_agency_billing",
        "download_route": "sales_report_agency_billing_export",
        "downloadable": True,
    },
    {
        "id": "manager_insight",
