...
(function (global) {
  ...
  function buildLegacyCustomerBillHtml(invoice, opts) {
    ...
    return (
      ...
      'h1{font-size:17px;margin:0 0 4px;text-align:center;letter-spacing:.04em}' +
      '.sub{font-size:12px;text-align:center;color:#555;margin-bottom:10px}' +
      '.meta{font-size:13px;margin-bottom:10px;border-bottom:1px dashed #333;padding-bottom:8px}' +
      '.meta div{display:flex;justify-content:space-between;margin:2px 0;gap:8px}' +
      'table.items{width:100%;border-collapse:collapse;font-size:13px}' +
      'table.items th{text-align:left;font-size:12px;border-bottom:1px solid #333;padding:4px 0}' +
      ...
      '.totals .grand{font-size:16px;font-weight:700;border-top:1px solid #333;margin-top:6px;padding-top:6px}' +
  ...
  function buildSpiceCustomerBillHtml(invoice, opts) {
    ...
    return (
      ...
      '.meta{font-size:13.5px;margin:0 0 10px}' +
      ...
      'table.items{width:100%;border-collapse:collapse;font-size:13.5px;margin:0 0 10px}' +
      'table.items th{text-align:left;font-size:13.5px;font-weight:700;padding:5px 0;border-bottom:1px solid #333;text-transform:uppercase;letter-spacing:.02em}' +
      ...
      '.totals .grand>span:first-child{font-size:18px;font-weight:800;letter-spacing:.01em}' +
      '.totals .grand>span:last-child{font-size:22px;font-weight:800;letter-spacing:.01em;font-variant-numeric:tabular-nums}' +
      '.section-title{text-align:center;font-weight:700;font-size:14.5px;margin:10px 0 6px;letter-spacing:.02em}' +
      '.receipts{margin-top:6px}' +
      'table.receipts-table{width:100%;border-collapse:collapse;font-size:13.5px}' +
      'table.receipts-table th{font-size:13.5px;font-weight:700;text-align:left;padding:5px 0;border-bottom:1px solid #333;text-transform:uppercase;letter-spacing:.02em}' +
      ...
      '.receipts-total{text-align:right;font-weight:800;margin-top:6px;font-size:17px}' +
      '.user{margin-top:12px;font-size:13px;font-weight:400}' +
      cancelledCss +
      '@media print{' +
