...
class AppShellPwaTests(unittest.TestCase):
    ...
    def test_service_worker_is_public_app_shell(self):
        ...
        self.assertIn("login-field", body)
        self.assertIn("hbe_login_fonts.css", body)
    ...
    def test_offline_login_shell_is_public(self):
        ...
        self.assertIn("hbe_login_fonts.css", html)
        self.assertIn("login_premium.css", html)
        self.assertIn("login-mark--badge", html)
        ...
        self.assertIn("/static/offline_login.html", html)
        self.assertNotIn("Reconnect to sign in.", html)
        self.assertNotRegex(html, re.compile(r"/static/[^\"'\s]+\?v=\d+\b"))
